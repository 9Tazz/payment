...
import 'package:flutter_application_1/my_constant.dart';
import 'package:flutter_application_1/my_dialog.dart';
import 'package:flutter_application_1/nav_confirm_add_wallet.dart';
import 'package:flutter_application_1/show_progress.dart';
import 'package:flutter_application_1/show_title.dart';
    ...
    return Container(
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          trailing: IconButton(
              onPressed: () {
                Clipboard.setData(ClipboardData(text: '0987654321'));
